/* ClickButton library demo
  ...
  Blinks a LED according to different clicks on one button:
    ...
    Click-and-hold functions (hold button for one second or longer):
    
    Single-click held down - Slow blink   (Toggles LED every second)
    Double-click held down - Sloow blink  (Toggles LED every other second)
    Triple-click held down - Slooow blink (Toggles LED every three seconds)
...
ClickButtonFsr button1(buttonPin1, 300, 500);
